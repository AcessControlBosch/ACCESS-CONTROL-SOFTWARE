...
export default {
    ...
    created(){
        console.log('this.$store.state.machine', this.$store.state.idmachine)
        this.$axios.get(this.$store.state.BASE_URL + '/greenbooks/'+ this.$store.state.idmachine +'/1').then((response) => {
